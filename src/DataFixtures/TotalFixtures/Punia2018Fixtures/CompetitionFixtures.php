...
{
    public const COMPETITION_REFERENCE = "total_punia";
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $competition->setCompetitionName("Pikts Karpis, Punia 2018");
        $competition->setCompetitionDate(new \DateTime("2018-05-04"));
