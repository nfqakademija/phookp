...
class CompetitionFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $competition->setCompetitionRules("1. Varžomasi komandoje, komandą sudaro 2-3 karpininkai, komandą gali lankyti svečiai, tačiau jie negali padėti varžybų dalyviams.
2. Tyrinėti sektorių markeriu, jaukinti žuvį ir masalus mesti į vandenį galima tik nuo varžybų starto pradžios.
3. Žvejoti galima 4 įrankiais turinčiais po 1 kablį. Paruoštų įrankių skaičius neribojamas.
