...
class CompetitionFormType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('competitionRules', TextareaType::class, array("required"=>false,"label" => "form.competition_registration.rules", 'attr' => ['placeholder' => "form.competition_registration.rules"]))
        ;
    }
