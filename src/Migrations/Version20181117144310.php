 ...
 */
final class Version20181117144310 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team DROP team_members');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team ADD team_members VARCHAR(135) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
